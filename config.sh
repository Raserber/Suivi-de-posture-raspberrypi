...
sudo apt-get install -y python3 python3-venv python3-pip python3-dev libglib2.0-dev
sudo python3 -m venv /home/admin/venv
...
sudo /home/admin/venv/bin/pip install --upgrade pip
sudo /home/admin/venv/bin/pip install bluepy paho.mqtt
...
sudo cp /home/admin/passerelle.service /etc/systemd/system/
sudo systemctl daemon-reload
sudo systemctl enable passerelle.service
sudo systemctl start passerelle.service
